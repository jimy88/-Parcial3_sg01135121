    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualizar Datos Profesor</h5>
            ...
            <div class="form-group">
                <label for="dui"></label>
                <input wire:model="dui" type="text" class="form-control" id="dui" placeholder="Dui">@error('dui') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
